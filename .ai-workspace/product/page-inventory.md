...
- 当前仓库只维护 `hybird-meumall` H5 C 端；旧 `server-meumall`、`admin-meumall`、`app-meumall` 已退役/外部化。页面盘点中出现的 App、Tab、WebView 或 Bridge 仅表示外部运行环境假设，不代表本仓库需要实现 iOS/App、管理后台或后端服务。
