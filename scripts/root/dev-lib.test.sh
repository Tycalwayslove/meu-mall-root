...
MEUMALL_TEST_HTTP_READY_PORTS="4100"
MEUMALL_TEST_LISTENING_PORTS="4100 9999"
TMP_DIR="$(mktemp -d)"
...
assert_eq "$(service_url "127.0.0.1" "4100" "/api/health")" "http://127.0.0.1:4100/api/health" "builds service URL"
...
assert_eq "$(service_start_decision "server" "4100" "http://127.0.0.1:4100/api/health")" "reuse" "reuses healthy existing service"
assert_eq "$(service_start_decision "h5" "3109" "http://127.0.0.1:3109/hybird")" "start" "starts free service port"
assert_eq "$(service_start_decision "admin" "9999" "http://127.0.0.1:9999/")" "blocked" "blocks occupied unhealthy port"
